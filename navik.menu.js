...
jQuery(document).ready(function() {
	...
	function stickyNav() {
		...
		if (scrollTop > navikHeaderHeight) {
			...
			headerOpacityLgNosticky.addClass('');
			viewportLgBody.css("margin-top", navikHeaderHeight);
			// viewportLg.css("margin-top", -navikHeaderHeight);
			viewportLgBody.add(viewportLg).css("padding-top", "7px");
			viewportLgBody.add(viewportLg).css("padding-bottom", "7px");
		} else {
			navikHeader.removeClass('sticky');
			viewportLgLogo.attr('src', logoSrc);
			headerTransparentLg.addClass('header-transparent-on');
			headerOpacityLg.addClass('header-opacity-on');
			viewportLgBody.add(viewportLg).css("padding-top", "15px");
			viewportLgBody.add(viewportLg).css("padding-bottom", "15px");
		}
